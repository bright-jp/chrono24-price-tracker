...
Info  : https://brightdata.jp/products/insights/price-tracker/chrono24
"""
...
# https://brightdata.jp/products/web-scraper/chrono24
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Chrono24 scraper at: https://brightdata.jp/products/web-scraper/chrono24\n"
